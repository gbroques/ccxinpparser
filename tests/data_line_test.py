...
class DataLineTest(unittest.TestCase):
    ...
    def test_parse_inp_with_empty_data(self):
        contents = """
        ** Defines an element set "E1" with three elements: 1, empty, and 3.
        *ELSET,ELSET=E1
        1,,3,4
        """
        ...
        data_line = keyword_card.children[2]
        self.assertEqual(data_line.data, 'data_line')
        self.assertEqual(len(data_line.children), 4)
        ...
        element2_token = element2.children[0]
        self.assertEqual(element2_token.type, 'INT')
        self.assertEqual(element2_token.value, '0')
        # ----------------------------------------------
